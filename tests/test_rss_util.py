...
class TestRssUtil(unittest.TestCase):
    ...
    def test_build_url(self):
        ...
        item_url = self.plg_utils.build_url(
            base_url="https://guts.github.io/mkdocs-related-content/", path="changelog"
        )
        self.assertTrue(checkers.is_url(item_url))

        # with URL parameters
        item_url = self.plg_utils.build_url(
            base_url="https://guts.github.io/mkdocs-related-content/",
            path="changelog",
    ...
    def test_remote_image_none(self):
        ...
        img_length = self.plg_utils.get_remote_image_length(
            image_url="https://guts.github.io/mkdocs-related-content/inexisting.svg"
        )
        self.assertIsNone(img_length)
