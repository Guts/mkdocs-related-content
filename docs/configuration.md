...
- `default_timezone`: timezone to use by default to make aware datetimes. Default to `UTC`. Introduced in version 1.3.0 with [PR 142](https://github.com/Guts/mkdocs-related-content/pull/142).
- `default_time`: time to use if page contains only a date. Useful to avoid the 'midnight syndrome' or have to specify hour in every single page. Default to `None`. 24h-clock format is expected: `%H:%M`. Example: `"14:20"`. Introduced in version 1.4.0 with [PR 145](https://github.com/Guts/mkdocs-related-content/pull/145).
...
plugins:
  - rss:
      image: https://github.com/Guts/mkdocs-related-content/blob/main/docs/assets/logo_rss_plugin_mkdocs.png?raw=true
```
...
<image>
  <url>
    https://github.com/Guts/mkdocs-related-content/blob/main/docs/assets/logo_rss_plugin_mkdocs.png?raw=true
  </url>
  <title>MkDocs RSS Plugin</title>
  <link>https://guts.github.io/mkdocs-related-content/</link>
</image>
```
...
<rss>
    ...
    <item>
      [...]
      <link>https://guts.github.io/mkdocs-related-content/?utm_source=documentation&amp;utm_medium=RSS&amp;utm_campaign=feed-syndication</link>
      [...]
    </item>
    [...]
  </channel>
