...
# package
from mkdocs_related_content.__about__ import __title_clean__
from mkdocs_related_content.integrations.theme_material_social_plugin import (
...
class TestRssPluginIntegrationsMaterialSocialCards(BaseTest):
    ...
    def test_plugin_config_social_cards_enabled_with_directory_urls_disabled(self):
        """Test case described in https://github.com/Guts/mkdocs-related-content/issues/319."""
        # default reference
        cfg_mkdocs = load_config(
            str(
                Path(
